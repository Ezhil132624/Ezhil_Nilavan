...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      id: 10,
      title: 'Hashtag_Hero',
      description: 'Hashtag Hero is your AI-powered content creator for LinkedIn and Instagram. Just enter your project or topic, and get instant post ideas with catchy descriptions, trending hashtags, and ready-to-share images — all designed to boost your social media presence effortlessly.',
      image: '/image/Hashtag_Hero.png',
      tags: ['Html', 'Css', 'JavaScript', 'React'],
      demoLink: 'https://hashtag-hero.vercel.app/',
      codeLink: 'https://github.com/Ezhil132624/Hashtag_Hero',
    },
  ];
